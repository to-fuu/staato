        ...
        <div
            ...
            <h1 className={'text-center text-[12vw] leading-[1.2] font-bold font-heading text-rose-500 text-stroke]'}>
                ...
                <div className={'flex  justify-center items-center'}>
                    <Parallax scrollStartOffset={120} speed={0.3}>3</Parallax>.<Parallax scrollStartOffset={120}
                                                                                          speed={0.6}>2</Parallax>.<Parallax
                    scrollStartOffset={120} speed={1.2}>1</Parallax>
                </div>
